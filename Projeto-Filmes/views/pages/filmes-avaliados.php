...
<body>
    ...
    <div class="container-body">
        <h2 class="text-center mb-4">Apenas os Filmes Avaliados</h2>

        <div class="row">

            <?php
            $result = $mysqli->query("SELECT * FROM filmes WHERE nota > 0");
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text m-0"><b>Avaliação:</b> <?= $row['avaliacao'] ?></p>
